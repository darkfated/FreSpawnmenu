...
local function ButtonPaint(self, w, h, name, fav_bool)
	...
	draw.RoundedBox(4, 0, 0, w, h, fav_bool and color_bluepurpl or ((frespawnmenu_content:GetString() == name or toolmode:GetString() == name) and color_blue or color_button_outline))
...
--[[---------------------------------------------------------
	Menu
-----------------------------------------------------------]]
local color_spacer = Color(121,121,121,100)
...
local color_slider = Color(0,0,0,100)

function SKIN:PaintNumSlider(panel, w, h)
	surface.SetDrawColor(color_slider)
